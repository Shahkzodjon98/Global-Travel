  ...
  return (
    <>
      <div className="flex items-center justify-center flex-col mx-auto">
        <div className=" container  my-24 mx-auto flex flex-col md:flex-row justify-center items-center gap-20">
          {/* Image */}
          <Image
            src={travelerspoint}
            alt="Travelers Point"
            ...
            <div className="grid grid-cols-2 md:grid-cols-2 gap-24 ">
              ...
              <div className=" flex flex-col py-6 ">
                ...
                <div className=" my-10">
                  ...
                  <p className="text-zinc-700 text-base font-normal font-Poppins md:items-center flex justify-center   leading-7">
