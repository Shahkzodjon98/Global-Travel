...
const FourOurTeams = () => {
  ...
  <div className="flex items-start flex-col space-y-4 sm:space-y-2 md:space-y-2">
    <h1 className="text-zinc-700 text-2xl sm:text-3xl md:text-[27.65px] font-bold font-'Poppins' leading-[33.18px] sm:leading-[34px] md:leading-[33.18px] md:mx-0 mx-auto">Our Teams</h1>
    <p className="text-zinc-700 text-base sm:text-lg font-normal font-'Poppins' leading-7 sm:leading-6  md:mx-0 mx-auto">Lorem ipsum dolor sit amet</p>
    <div className="grid grid-cols-2 md:gap-16 gap-5 sm:grid-cols-2 md:grid-cols-5 md:p-0 p-2">
