  ...
  return (
    ...
    <div className=" flex items-center flex-col my-10 mx-10">
      <div className=" flex-col first-line:uppercase first-line:tracking-widest
        ...
        <p className=" w-full  text-black text-base font-normal font-'Poppins' leading-7">D Lorem ipsum dolor sit amet, consectetur adipiscing elit ut aliquam, purus sit amet luctus venenatis, lectus magna fringilla urna, porttitor rhoncus dolor purus non enim praesent elementum facilisis leo, vel fringilla est ullamcorper eget nulla facilisi.</p>
        <p className="w-full text-black text-base font-normal font-'Poppins' leading-7">enim lobortis scelerisque fermentum dui faucibus in ornare quam viverra orci sagittis eu volutpat odio facilisis mauris sit amet massa vitae tortor condimentum lacinia quis vel eros donec ac odio tempor orci dapibus ultrices in iaculis nunc sed augue lacus, viverra vitae congue eu, consequat ac felis donec et odio pellentesque diam volutpat commodo sed egestas egestas fringilla fau.</p>
      </div>
      <div className="flex flex-col my-6 w-full">
        <div className="">
        <Image src={Rectangle17} alt="" className="w-full"/>
        </div>
        <div className=" my-6">
