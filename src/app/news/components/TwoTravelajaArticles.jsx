    ...
    <div>
      <div className=" flex items-center justify-center mx-auto my-10">
        <div className="container mx-auto my-5 sm:my-10">
          ...
          <div className="flex flex-col items-center my-5 sm:flex-row sm:justify-center sm:my-10 gap-10">
            <Link href="/">
              <p className="text-white text-base font-bold font-['Poppins'] leading-7  px-5 py-2.5 bg-[#43B97F] rounded-[5px]">
                Adventure Travel
              </p>
            </Link>
            <Link href="/">
              <p className="text-[#43B97F] text-base font-bold font-['Poppins'] leading-7">
                Beach
              </p>
            </Link>
            <Link href="/">
              <p className="text-zinc-700 text-base font-bold font-['Poppins'] leading-7">
                Explore World
              </p>
            </Link>
            <Link href="/">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-5 mx-auto my-10">
            <div className="flex items-center flex-col space-y-5 ">
              ...
              <div className="mx-2 sm:mx-5 md:mx-10 flex flex-col">
